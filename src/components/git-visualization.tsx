...
// Hoisted to module scope. Defined inside GitVisualization, these were new
// component identities on every parent render, so changing the selected view
// remounted the whole subtree instead of swapping it. See defect D2.10.
